Feature: Interacting with UI elements on Different Elements page and checking their logs
  In order to check Logs after interacting with UI elements
  As a logged user
  I want to select two checkboxes, one radio and one dropdown and check logs
